...
--// matrix.mulelements ( m1, m2 )
-- Multiply each element of m1 with according element of m2
function matrix.mulelements( m1, m2)
  local m = matrix:new(#m1,#m1[1])
  for i = 1,#m1 do
    for j = 1,#m1[1] do
      m[i][j] = m1[i][j] * m2[i][j]
    end
...
matrix.vector_intersection = function( a, b, c, d )
